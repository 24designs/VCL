<?php
   ...
   * ===================================================== */
  $email_to = " info@ventureit.info"; 
  $email_from = " www.ventureit.info"; // must be different than $email_from 
  ...
  $email_from =$_POST['email'];
      ...
      else 
      {
          ...
          header('Location: contact.html?s='.urlencode('An error occured. Please try again later.')); exit; 
          die();        
      }
  }
  else
